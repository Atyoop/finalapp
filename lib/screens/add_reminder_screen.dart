  ...
  Future<void> _saveMedicine() async {
    ...
    try {
      ...
      final success = widget.initialMedicine != null
          ? await medProvider.updateMedicineOnApi(token, medicine)
          : await medProvider.addMedicineToApi(token, medicine);
      ...
      if (success) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(medProvider.error ?? 'Failed to save')),
          );
        }
      }
    } catch (e) {
