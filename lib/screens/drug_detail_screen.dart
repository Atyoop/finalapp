      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                ...
                children: [
                  ...
                  if (isCustomMedication) ...[
                    ...
                    Container(
                      ...
                      child: Text(
                        context.l10n.t('manualMedication'),
                        style: TextStyle(
                          fontSize: 12,
            ...
            if (isCustomMedication)
              _SectionCard(
                title: context.l10n.t('manualMedication'),
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: isCustomMedication || supportsInteractions == false
                      ? null
                      : () => Navigator.push(
                          context,
                          MaterialPageRoute(
            ...
            if (isCustomMedication || supportsInteractions == false)
              Padding(
